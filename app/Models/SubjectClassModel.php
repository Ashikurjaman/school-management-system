...
class SubjectClassModel extends Model
{
    ...
    public static function classGetData()
    {
        $return = self::select('class_subject.*', 'subjects.name as subject_name', 'class.name as class_name', 'users.name as created_by_name')
    ...
    public static function getFirst($class_id, $subject_id)
    {
        return self::where('class_id', '=', $class_id)->where('subject_id', '=', $subject_id)->first();
    }

    public static function subClassData ($id){
        return self::find($id);
    }
}
